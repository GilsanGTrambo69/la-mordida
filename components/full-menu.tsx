...
const menuItems: MenuItem[] = [
  {
    ...
    ingredients: ["Pan brioche", "Salsa de ajo de la casa", "Lechuga", "Doble tocineta", "Carne artesanal", "Queso doble crema", "Queso cheddar", "Tomate", "Papas francesas"],
    proteins: [],
  },
  {
    ...
    category: "hamburguesas",
    ingredients: ["Pan brioche", "Salsa de ajo de la casa", "Lechuga", "Piña asada", "Carne artesanal", "Medallon de platano maduro", "Suero costeño", "Queso doble crema", "Tomate", "Papas francesas"],
    proteins: [],
  },
  {
    ...
    category: "hamburguesas",
    ingredients: ["Pan brioche", "Salsa de ajo de la casa", "Lechuga", "Carne artesanal", "Queso doble crema", "Tocineta en reduccion de vino tinto", "Papas francesas"],
    proteins: [],
  },
  {
    name: "Hamburguesa Clásica + Salchipapas",
    description: "Pan brioche, lechuga, 150g de carne artesanal, 100g de queso doble crema, crema, 100g de panceta, tomate, tocineta, salsas de la casa y salchipapas.",
    price: "$25.000",
  ...
  },
  {
    ...
    description: "Papas, salsas de la casa, salchicha, lechuga, Vegetal de elección, 200g de proteína a elección, cabello de ángel y queso cheddar.",
    price: "$37.000",
  ...
  },
  {
    ...
    description: "Papas, salsas de la casa, salchicha, lechuga, Vegetal de elección, 80g de proteína a elección, cabello de ángel y queso fundido.",
    price: "$21.000",
