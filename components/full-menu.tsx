...
const menuItems: MenuItem[] = [
  {
    ...
    description: "Doble carne, queso cheddar fundido, lechuga, tomate y salsa secreta.",
    price: "$18.900",
  ...
  },
  {
    ...
    description: "Carne smash, tocineta crocante, cebolla caramelizada y salsa BBQ.",
    price: "$22.500",
  ...
  },
  {
    ...
    description: "Triple carne, triple queso, jalapenos y salsa picante.",
    price: "$28.900",
  ...
  {
    name: "Mordida Jr.",
    description: "Hamburguesa sencilla con queso, lechuga y tomate. Perfecta para los peques.",
    price: "$12.900",
    image: "/images/burger-classic.jpg",
    category: "hamburguesas",
  },
  {
    name: "Perro Loco",
    description: "Salchicha premium, queso derretido, papas crocantes y salsas.",
    price: "$14.500",
  ...
  {
    name: "Perro Ranchero",
    description: "Salchicha, carne desmechada, queso mozzarella y maiz.",
    price: "$16.900",
    image: "/images/hot-dog.jpg",
    category: "perros",
  },
  {
    ...
    description: "Papa gruesa, salchicha y salsas. La de toda la vida.",
    price: "$12.900",
  ...
  },
  {
    ...
    description: "Papa gruesa, salchicha doble, queso, tocineta y salsas.",
    price: "$16.900",
    image: "/images/salchipapa.jpg",
    category: "salchipapas",
  },
  {
    name: "Combo Personal",
    description: "Hamburguesa clasica + papas medianas + gaseosa.",
    price: "$26.900",
  ...
  {
    name: "Combo Familiar",
    description: "2 hamburguesas clasicas + papas grandes + 2 gaseosas.",
    price: "$42.900",
    image: "/images/combo-meal.jpg",
    category: "combos",
  },
